...
#JobID = 0
FileName = "Results/CyanoFrag_Fitting_Quadratic_concave_consumption_model_"+str(JobID)+".txt"
File2Write = open(FileName, "w")
String2Write = "W, K, Scale, Max_effect, empty_1, empty_2, empty_3, Flag_consumption_model, Init_conc_comp, D_comp, Deviation"+'\n'
File2Write.write(String2Write)

""" initialization """

TheModel = CMS.QuadraticConcaveConsumptionModel
...
Parameters = [W, K, Scale, Max_effect, 0, 0, 0, 1, Init_conc_comp, D_comp]
