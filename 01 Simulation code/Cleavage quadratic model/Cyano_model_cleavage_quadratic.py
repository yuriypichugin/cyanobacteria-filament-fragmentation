...
#JobID = 0
FileName = "Results/CyanoFrag_Fitting_Quadratic_Cleavage_model_"+str(JobID)+".txt"
File2Write = open(FileName, "w")
String2Write = "W, K, Scale, Min_effect, empty_1, empty_2, empty_3, empty_4, P_comp, D_comp, Deviation"+'\n'
File2Write.write(String2Write)

""" initialization """

TheModel = CMS.QuadraticCleavageModel
...
Parameters = [W, K, Scale, Min_effect, 0, 0, 0, 0, P_comp, D_comp]
