...
#JobID = 0
FileName = "Results/CyanoFrag_Fitting_sigmoid_consumption_model_"+str(JobID)+".txt"
File2Write = open(FileName, "w")
String2Write = "W, K, Max_effect, TransitionWidth, TransitionConc, empty_2, empty_3, Flag_consumption_model, Init_conc_comp, D_comp, Deviation"+'\n'
File2Write.write(String2Write)

""" initialization """

TheModel = CMS.SigmoidConsumptionModel
...
Max_effect = np.power(10, np.random.uniform(-4, 1))
TransitionWidth = np.power(10, np.random.uniform(-2, 2))
TransitionConc = np.power(10, np.random.uniform(-4, 0))
Parameters = [W, K, Max_effect, TransitionWidth, TransitionConc, 0, 0, 1, Init_conc_comp, D_comp]
