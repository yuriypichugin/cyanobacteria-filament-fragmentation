...
FolderName = 'Consumption constant model/'
File2WriteName = 'Consumption_constant_model_last_entry_nofilter.txt'
DataFileMask = 'CyanoFrag_Fitting_Constant_consumption_model_'
ExtractData(FolderName, DataFileMask, File2WriteName)
File2WriteFirstName = 'Consumption_constant_model_first_entry.txt'
ExtractInitialData(FolderName, DataFileMask, File2WriteFirstName)


FolderName = 'Consumption exponent model/'
File2WriteName = 'Consumption_exponent_model_last_entry_nofilter.txt'
DataFileMask = 'CyanoFrag_Fitting_decay_exponent_consumption_model_'
ExtractData(FolderName, DataFileMask, File2WriteName)
File2WriteFirstName = 'Consumption_exponent_model_first_entry.txt'
ExtractInitialData(FolderName, DataFileMask, File2WriteFirstName)

FolderName = 'Consumption inverse model/'
File2WriteName = 'Consumption_inverse_model_last_entry_nofilter.txt'
DataFileMask = 'CyanoFrag_Fitting_Inverse_consumption_model_'
ExtractData(FolderName, DataFileMask, File2WriteName)
File2WriteFirstName = 'Consumption_inverse_model_first_entry.txt'
ExtractInitialData(FolderName, DataFileMask, File2WriteFirstName)

FolderName = 'Consumption linear model/'
File2WriteName = 'Consumption_linear_model_last_entry_nofilter.txt'
#DataFileMask = 'CyanoFrag_Fitting_Threshold_Cleavage_model_'
DataFileMask = 'CyanoFrag_Fitting_Linear_consumption_model_'
ExtractData(FolderName, DataFileMask, File2WriteName)
File2WriteFirstName = 'Consumption_linear_model_first_entry.txt'
ExtractInitialData(FolderName, DataFileMask, File2WriteFirstName)

FolderName = 'Consumption quardratic concave model/'
File2WriteName = 'Consumption_quadratic_concave_model_last_entry_nofilter.txt'
DataFileMask = 'CyanoFrag_Fitting_Quadratic_concave_consumption_model_'
ExtractData(FolderName, DataFileMask, File2WriteName)
File2WriteFirstName = 'Consumption_quadratic_concave_model_first_entry.txt'
ExtractInitialData(FolderName, DataFileMask, File2WriteFirstName)

FolderName = 'Consumption quardratic convex model/'
File2WriteName = 'Consumption_quadratic_convex_model_last_entry_nofilter.txt'
DataFileMask = 'CyanoFrag_Fitting_Quadratic_convex_consumption_model_'
ExtractData(FolderName, DataFileMask, File2WriteName)
File2WriteFirstName = 'Consumption_quadratic_convex_model_first_entry.txt'
ExtractInitialData(FolderName, DataFileMask, File2WriteFirstName)

FolderName = 'Consumption sigmoid model/'
File2WriteName = 'Consumption_sigmoid_model_last_entry_nofilter.txt'
DataFileMask = 'CyanoFrag_Fitting_sigmoid_consumption_model_'
ExtractData(FolderName, DataFileMask, File2WriteName)
File2WriteFirstName = 'Consumption_sigmoid_model_first_entry.txt'
ExtractInitialData(FolderName, DataFileMask, File2WriteFirstName)

FolderName = 'Consumption step model/'
File2WriteName = 'Consumption_step_model_last_entry_nofilter.txt'
DataFileMask = 'CyanoFrag_Fitting_Step_consumption_model_'
ExtractData(FolderName, DataFileMask, File2WriteName)
File2WriteFirstName = 'Consumption_step_model_first_entry.txt'
ExtractInitialData(FolderName, DataFileMask, File2WriteFirstName)
