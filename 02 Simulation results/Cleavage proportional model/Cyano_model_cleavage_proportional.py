...
#JobID = 0
FileName = "Results/CyanoFrag_Fitting_Proportional_Cleavage_model_"+str(JobID)+".txt"
File2Write = open(FileName, "w")
String2Write = "W, K, empty_0, Slope, empty_1, empty_2, empty_3, empty_4, P_comp, D_comp, Deviation"+'\n'
File2Write.write(String2Write)

""" initialization """

TheModel = CMS.ProportionalCleavageModel
