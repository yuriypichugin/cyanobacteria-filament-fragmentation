...
#JobID = 0
FileName = "Results/CyanoFrag_Fitting_Step_consumption_model_"+str(JobID)+".txt"
File2Write = open(FileName, "w")
String2Write = "W, K, Threshold, Effect, empty_1, empty_2, empty_3, Flag_consumption_model, Init_conc_comp, D_comp, Deviation"+'\n'
File2Write.write(String2Write)

""" initialization """

TheModel = CMS.StepConsumptionModel
...
Conc_treshold = 0
Threshold = np.power(10, np.random.uniform(-6.0, 0.0))
#Slope = np.power(10, np.random.uniform(-2.0, 1.0))
Effect = np.power(10, np.random.uniform(-4, 1))
Parameters = [W, K, Threshold, Effect, 0, 0, 0, 1, Init_conc_comp, D_comp]
